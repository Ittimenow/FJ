export const realtimeEvents = {
  ...
  dealBuy: "deal:buy",
  dealSell: "deal:sell",
  dealAuctionStart: "deal:auction_start",
  dealAuctionBid: "deal:auction_bid",
  dealAuctionDecline: "deal:auction_decline",
  dealAuctionSelect: "deal:auction_select",
  dealAuctionCancel: "deal:auction_cancel",
  loanTake: "loan:take",
