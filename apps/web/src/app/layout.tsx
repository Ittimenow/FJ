...
const socialDescription =
  "Создайте командную комнату без верхнего лимита участников или начните одиночную партию с виртуальными соперниками. Принимайте решения и управляйте денежным потоком.";
...
export const metadata: Metadata = {
  ...
  description:
    "Создавайте командные игровые комнаты без верхнего лимита участников, управляйте доходами и расходами, оценивайте сделки и развивайте финансовое мышление.",
  openGraph: {
    title: socialTitle,
