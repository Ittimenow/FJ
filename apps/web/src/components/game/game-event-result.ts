...
const eventReasonLabels: Record<string, string> = {
  ...
  deal_auction_started: "возможность выставлена на аукцион",
  deal_auction_response_recorded: "ответ на аукционе принят",
  deal_auction_no_offers: "все игроки отказались от возможности",
  deal_auction_cancelled: "аукцион закрыт без продажи",
  deal_auction_completed_turn_ended: "возможность продана, ход завершен",
